/******************************************************************************
Declare  a  union  containing  5  string  variables  (Name,  House  Name,  City 
Name, State and  Pin code) each with a length of C_SIZE (user defined constant).
